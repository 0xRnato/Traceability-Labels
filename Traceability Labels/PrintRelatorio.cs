...
namespace pre_pesagem
{
    class printRelatorio
    {
        ...
        public static void Print(DataGridView dgv1)
        {
                    ...
                    System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewColumn GridCol in dgv.Columns)
                {
                    ...
                    if (!printRelatorio.SelectedColumns.Contains(GridCol.HeaderText)) continue;
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            {
                                if (!GridCol.Visible) continue;
                                if (!printRelatorio.SelectedColumns.Contains(GridCol.HeaderText))
                                    continue;
